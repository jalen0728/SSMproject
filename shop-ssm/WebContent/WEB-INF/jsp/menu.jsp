...
<div >
	<form action="${ pageContext.request.contextPath }/seachProduct" method="post" >
		<input type="hidden" name="page" value="1"/>
		商品类别:<input type="text" name="proCategory"/>
		商品价格区间:<input type="text" name="proPriceMin"/>一
		<input type="text" name="proPriceMax"/>
